...
const VALIDATORS = {
  ...
  versionVariable: canBeDisabled(isNonEmptyString),
  releasenotePath: canBeDisabled(isNonEmptyString),
  prepareCmd: canBeDisabled(isNonEmptyString),
  publishCmd: canBeDisabled(isNonEmptyString),
};
